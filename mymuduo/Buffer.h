...
public:
    ...
    static const size_t kInitialSize = 1024; //初始缓冲区的大小
...
private:
    ...
    {
        if (writableBytes() + prependableBytes() < len + kCheapPrepend)  //pre是前面空闲区域
        {
